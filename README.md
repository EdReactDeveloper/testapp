...
Ссылку на публичный профиль гитхаб с  выполненным тестовым заданием и ссылку на ваше резюме отправлять на почту:  h.resources@takeoff-staff.ru с темой письма «ФИО frontend ( NameFramefork )», где NameFramefork: React
